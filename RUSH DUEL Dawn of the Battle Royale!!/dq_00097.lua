...
--Hand (yours)
Debug.AddCard(160004019,0,0,LOCATION_HAND,0,POS_FACEDOWN)
...
--Monster Zones (yours)
Debug.AddCard(160421004,0,0,LOCATION_MZONE,1,POS_FACEUP_ATTACK)
Debug.AddCard(160201001,0,0,LOCATION_MZONE,2,POS_FACEUP_ATTACK)

--Main Deck (opponent's)
Debug.AddCard(160001002,1,1,LOCATION_DECK,0,POS_FACEDOWN)

--Monster Zones (opponent's)
Debug.AddCard(160004031,1,1,LOCATION_MZONE,1,POS_FACEUP_ATTACK)
