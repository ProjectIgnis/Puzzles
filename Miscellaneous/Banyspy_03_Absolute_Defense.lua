...
4. Play around Mystic Mind by control monster count. Be mindful of what need to be on the end board to pull off OTK.
]]
...
Debug.SetPlayerInfo(1,36500,0,0)

    --Player's deck
Debug.AddCard(34959756,0,0,LOCATION_DECK,0,POS_FACEDOWN) --living fossil
Debug.AddCard(34959756,0,0,LOCATION_DECK,0,POS_FACEDOWN) --living fossil
Debug.AddCard(34959756,0,0,LOCATION_DECK,0,POS_FACEDOWN) --living fossil
...
Debug.AddCard(44330098,0,0,LOCATION_MZONE,1,POS_FACEUP_ATTACK) --Gorz
Debug.AddCard(44330098,0,0,LOCATION_MZONE,2,POS_FACEUP_ATTACK) --Gorz
Debug.AddCard(44330098,0,0,LOCATION_MZONE,3,POS_FACEUP_ATTACK) --Gorz
...
Debug.PreSummon(zero,SUMMON_TYPE_LINK,LOCATION_EXTRA)
    ...
    --Ai's and Player's extra deck 
for i =0,1 do
	Debug.AddCard(32559361,i,i,LOCATION_EXTRA,0,POS_FACEDOWN) --Chaos Dyson sphere
    Debug.AddCard(01992816,i,i,LOCATION_EXTRA,0,POS_FACEDOWN) --Dyson sphere
    Debug.AddCard(95685352,i,i,LOCATION_EXTRA,0,POS_FACEDOWN) --dark anthelion dragon
    Debug.AddCard(06983839,i,i,LOCATION_EXTRA,0,POS_FACEDOWN) --tornado dragon
    Debug.AddCard(82633039,i,i,LOCATION_EXTRA,0,POS_FACEDOWN) --castel
    Debug.AddCard(01686814,i,i,LOCATION_EXTRA,0,POS_FACEDOWN) --Ultimaya tzolkin
    Debug.AddCard(52687916,i,i,LOCATION_EXTRA,0,POS_FACEDOWN) --trishula
    Debug.AddCard(50954680,i,i,LOCATION_EXTRA,0,POS_FACEDOWN) --crystal wing
    Debug.AddCard(02403771,i,i,LOCATION_EXTRA,0,POS_FACEDOWN) --power tool
    Debug.AddCard(94677445,i,i,LOCATION_EXTRA,0,POS_FACEDOWN) --Ib
    Debug.AddCard(43387895,i,i,LOCATION_EXTRA,0,POS_FACEDOWN) --SK starving venom
    Debug.AddCard(41209827,i,i,LOCATION_EXTRA,0,POS_FACEDOWN) --starving venom
    Debug.AddCard(49513164,i,i,LOCATION_EXTRA,0,POS_FACEDOWN) --Raidjin
    Debug.AddCard(80532587,i,i,LOCATION_EXTRA,0,POS_FACEDOWN) --N'tss
    Debug.AddCard(54757758,i,i,LOCATION_EXTRA,0,POS_FACEDOWN) --mudragon
end

    --Player's hand
Debug.AddCard(69610326,0,0,LOCATION_HAND,0,POS_FACEUP) --darkwurm
Debug.AddCard(55878038,0,0,LOCATION_HAND,0,POS_FACEUP) --Chaos Dragon Levianeer
...
Debug.AddCard(83764718,0,0,LOCATION_HAND,0,POS_FACEUP) --monster reborn
Debug.AddCard(64034255,0,0,LOCATION_HAND,0,POS_FACEUP) --genex birdman
Debug.AddCard(99234526,0,0,LOCATION_HAND,0,POS_FACEUP) --white wyvernburster
...
local mob = Debug.AddCard(24845628,0,0,LOCATION_SZONE,1,POS_FACEUP) -- duster mob
Debug.AddCard(14470845,0,0,LOCATION_SZONE,2,POS_FACEDOWN) -- ojama duo
Debug.AddCard(46652477,0,0,LOCATION_SZONE,3,POS_FACEDOWN) -- shuffle 2 cards from GY
Debug.AddCard(13035077,0,0,LOCATION_SZONE,5,POS_FACEUP) -- dragonic diagram
Debug.PreEquip(mob,zero) -- Equip mob to Zeroboros
...
Debug.AddCard(52198054,1,1,LOCATION_GRAVE,0,POS_FACEUP) --blaze accelerator reload
Debug.AddCard(52198054,1,1,LOCATION_GRAVE,0,POS_FACEUP) --blaze accelerator reload
...
Debug.AddCard(69750546,1,1,LOCATION_DECK,0,POS_FACEDOWN) --scattershot
Debug.AddCard(69750546,1,1,LOCATION_DECK,0,POS_FACEDOWN) --scattershot
