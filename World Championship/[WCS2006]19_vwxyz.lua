...
Debug.AddCard(96300057,0,0,LOCATION_GRAVE,0,POS_FACEUP)
Debug.AddCard(82112775,0,0,LOCATION_GRAVE,0,POS_FACEUP)
...
-Activate 'D.D.M. - Different Dimension Master''s effect, discard 'Premature Burial' and select 'XYZ-Dragon Cannon'
-Activate 'XYZ-Dragon Cannon''s effect, discard 'Call of the Haunted' and select 'Lord of D.'
-Activate it again and select 'Blue-Eyes Ultimate Dragon'
-Activate 'VWXYZ-Dragon Catapult Cannon''s effect and select 'Blue-Eyes Ultimate Dragon'
-Attack 'Big Shield Gardna' with 'VWXYZ-Dragon Catapult Cannon', activate its effect
